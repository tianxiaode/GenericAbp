    ...
    where TOptions : OAuthOptions, new()
{
    ...
    public TOptions Get(string? name)
    {
        ...
        var scheme = typeof(TOptions).Name.Replace("AuthenticationOptions", "").Replace("Options", "");
        // 获取动态配置值
        var providerValue = _settingManager.GetProviderAsync(scheme).GetAwaiter().GetResult();
