function Secret(el, name, services, createModalName){
    let me = this;
    me.el = $(el);
    me.name = name;
...
Secret.prototype = {
    ...
    initGrid(){
        ...
        me.grid = me.el.w2grid({
            ...
            columns: [
                { field: 'type', text: l("Secrets:Type"), size: '25%', tooltip: l("Secrets:Type"), },
                { field: 'value', text: l("Secrets:Value"), size: '25%',tooltip: l("Secrets:Value"), },
                { field: 'description', text: l("Secrets:Description"), size: '25%', tooltip: l("Secrets:Description"), },
                { field: 'expiration', text: l("Secrets:Expiration"), size: '25%', tooltip: l("Secrets:Expiration"), },
            ],
