...
public class FolderPermission : AuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    public FolderPermission(Guid id, Guid folderId, string providerType, string? providerName = null,
        Guid? tenantId = null) :
        base(id)
    {
        FolderId = folderId;
