...
using System.Web;
using Generic.Abp.Account.Emailing.Templates;
...
public class AccountEmailer : IAccountEmailer, ITransientDependency
{
        ...
        string returnUrlHash = null)
    {
        ...
        var link =
            $"{url}?userId={user.Id}&{TenantResolverConsts.DefaultTenantKey}={user.TenantId}&resetToken={UrlEncoder.Default.Encode(resetToken)}";
