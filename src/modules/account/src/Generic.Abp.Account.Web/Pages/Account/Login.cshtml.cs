...
namespace Generic.Abp.Account.Web.Pages.Account
{
    public class LoginModel : AccountPageModel
    {
        ...
        protected virtual async Task ReplaceEmailToUsernameOfInputIfNeeds()
        {
            ...
            var userByPhoneNumber = UserManager.Users.FirstOrDefault(m => m.PhoneNumber == LoginInput.UserNameOrEmailAddress);
            if (userByPhoneNumber == null) return;


            LoginInput.UserNameOrEmailAddress = userByPhoneNumber.UserName;
        }
