...
using Generic.Abp.Account.Web.Areas.Account.Controllers.Models;
...
using UserLoginInfo = Generic.Abp.Account.Web.Areas.Account.Controllers.Models.UserLoginInfo;

namespace Generic.Abp.Account.Web.Areas.Account.Controllers
{
