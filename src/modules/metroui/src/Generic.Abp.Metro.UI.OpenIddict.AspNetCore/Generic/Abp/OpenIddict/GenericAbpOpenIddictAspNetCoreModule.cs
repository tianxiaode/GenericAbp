...
using Generic.Abp.OpenIddict.WildcardDomains;
...
public class GenericAbpOpenIddictAspNetCoreModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ViewLocationFormats.Add("/Generic/Abp/OpenIddict/Views/{1}/{0}.cshtml");
        });
    }
