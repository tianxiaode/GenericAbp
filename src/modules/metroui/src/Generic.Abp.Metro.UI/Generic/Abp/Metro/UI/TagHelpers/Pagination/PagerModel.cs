...
public class PagerModel
{
    ...
    public PagerModel(long totalCount, int shownItemsCount, int currentPage, int pageSize, string pageUrl,
        string sort = null)
    {
    ...
    {
        return TotalPageCount <= MaxItemsCountToShowAllPages ? GetAllPages() : GetPagesWithGaps();
    }
