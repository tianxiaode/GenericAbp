...
public class MetroDynamicFormTagHelperService :MetroTagHelperService<MetroDynamicFormTagHelper>
{
    ...
    {
        var abpSelectTagHelper = _serviceProvider.GetRequiredService<MetroSelectTagHelper>();
    ...
    protected virtual MetroTagHelper GetAbpRadioInputTagHelper(ModelExpression model)
    {
        ...
        var abpRadioInputTagHelper = _serviceProvider.GetRequiredService<MetroRadioInputTagHelper>();
    ...
    protected virtual async Task<string> ProcessSubmitButtonAndGetContentAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        abpButtonTagHelper.ButtonType = MetroButtonType.Primary;
    ...
    {
        var abpInputTagHelper = _serviceProvider.GetRequiredService<MetroInputTagHelper>();
