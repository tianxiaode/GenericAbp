...
public class MetroSelectTagHelperService : MetroTagHelperService<MetroSelectTagHelper>
{
    ...
    public MetroSelectTagHelperService(
    ...
    {
        if (TagHelper.AutocompleteApiUrl.IsNullOrEmpty()) return;
