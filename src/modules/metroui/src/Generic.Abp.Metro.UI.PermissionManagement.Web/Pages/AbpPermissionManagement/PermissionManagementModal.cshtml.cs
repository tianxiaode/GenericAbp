...
using Generic.Abp.Metro.UI.PermissionManagement.Web.Utils;
...
namespace Generic.Abp.Metro.UI.PermissionManagement.Web.Pages.AbpPermissionManagement;
...
public class PermissionManagementModal : AbpPageModel
{
    ...
    {
        ObjectMapperContext = typeof(GenericAbpMetroUiPermissionManagementWeb);
