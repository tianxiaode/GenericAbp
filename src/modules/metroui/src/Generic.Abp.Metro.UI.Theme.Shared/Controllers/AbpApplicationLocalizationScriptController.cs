...
[Area("Metro")]
[Route("metro/ApplicationLocalizationScript")]
[DisableAuditing]
[RemoteService(false)]
...
public class ApplicationLocalizationScriptController : AbpController
{
    ...
    private string CreateScript(ApplicationLocalizationDto localizationDto)
    {
        ...
        script.AppendLine();
        script.AppendLine($" abp.localization = _.defaultsDeep( abp.localization, {JsonSerializer.Serialize(localizationDto, indented: true)})");
        script.AppendLine();
        script.Append("})();");
