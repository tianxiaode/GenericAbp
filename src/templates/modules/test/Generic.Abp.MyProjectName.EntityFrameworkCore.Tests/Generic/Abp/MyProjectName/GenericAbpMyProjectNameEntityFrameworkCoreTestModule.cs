...
[DependsOn(
    typeof(GenericAbpMyProjectNameApplicationTestModule),
    typeof(GenericAbpMyProjectNameEntityFrameworkCoreModule),
    typeof(GenericAbpAbpEntityFrameworkCoreSqliteModule)
)]
public class GenericAbpMyProjectNameEntityFrameworkCoreTestModule : AbpModule
{
