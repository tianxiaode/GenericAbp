...
namespace QuickTemplate.Migrations
{
    ...
    [Migration("20241126133535_Add Module FileManagement and MenuManagement")]
    partial class AddModuleFileManagementandMenuManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Generic.Abp.FileManagement.FileInfoBases.FileInfoBase", b =>
                {
                    ...
                    b.HasIndex("ExpireAt", "RetentionPolicy");

                    b.ToTable("FileManagementFileInfoBases", (string)null);
                });

            modelBuilder.Entity("Generic.Abp.FileManagement.Resources.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("FileManagementResources", (string)null);
                });

            modelBuilder.Entity("Generic.Abp.FileManagement.Resources.ResourcePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ResourceId", "Permissions", "ProviderName", "ProviderKey");

                    b.ToTable("FileManagementResourcePermissions", (string)null);
                });
            ...
            modelBuilder.Entity("Generic.Abp.FileManagement.Resources.Resource", b =>
                {
                    b.HasOne("Generic.Abp.FileManagement.Resources.Resource", "Parent")
                        .WithMany("Children")
