...
{
    public static void AddQuickTemplateHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<QuickTemplateDatabaseCheck>("QuickTemplate DbContext Check",
        ...
        {
            settings.AddHealthCheckEndpoint("QuickTemplate Health Status", healthCheckUrl);
        });
