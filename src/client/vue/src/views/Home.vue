<template>
    <div class="hero">
        ...
        <el-button class="w-full" type="primary" @click="accountForm.success('Success Message')">Change
            ValueList</el-button>
    </div>
</template>

<script setup lang="ts">
import ValueListInput from '~/components/forms/ValueListInput.vue';
