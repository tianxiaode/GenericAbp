<template>
    <fieldset>
        ...
        <div class="w-full mb-2 text-center">
            <span class="text-xs text-gray-400 ">{{ t('OpenIddict.Settings:TokenLifetime.Description') }} </span>
        </div>
        <div class="grid grid-cols-2 gap-2">
            <el-form-item :label="t(ApplicationSettings.AccessToken.displayName)"
                prop="tokenLifetimesSettings.accessToken" label-width="210">
            ...
            <el-form-item :label="t(ApplicationSettings.DeviceCode.displayName)"
                prop="tokenLifetimesSettings.deviceCode" label-width="210">
