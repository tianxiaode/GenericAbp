<template>
    <el-dialog ref="dialogRef" :title="title" v-model="dialogVisible" :before-close="beforeDialogClose"
        ...
        <template #footer>
            <slot name="dialog-footer">
                ...
                <IconButton icon="fa fa-undo" @click="resetForm" style="order: 200;" circle
                    class="none-border"></IconButton>
...
const { formRef, formData, hasChange, resetForm, formExpose } = useFormExpose(props.formData);
